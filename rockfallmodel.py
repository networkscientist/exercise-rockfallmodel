...
# Original Work forked from: Andreas Zischg, Eva Amman 23.03.2020
...
np.savetxt(myworkspace + "/" + "rockfallhazardzoneSteepestPathAllStartpoints.asc", outarr, fmt="%i", delimiter=" ",
